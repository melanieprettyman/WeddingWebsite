...
export const CoupleConstants = {
  mitch: {
    name: "Mitch Wopat",
    about:
      "Mitch grew up in Germantown, Wisconsin, where his natural curiosity and love for discovery fueled his passion for science. His academic journey began with a degree in Biochemistry from Stevens Point, continued with a Master’s in Pharmacology at St. John’s University in New York City, and culminated in a PhD in Biochemistry at the University of Utah. When he’s not immersed in science, Mitch enjoys exploring imaginative worlds through sci-fi novels, expressing his creativity with painting, and unwinding with video games. As the only child of Tanya Weber and James Wopat, he shares a close bond with his family. Known for his sharp analytical mind and natural ability to lead, Mitch is a trusted friend, devoted son, and someone who inspires those around him.",
  },
  melanie: {
    name: "Melanie Prettyman",
    about:
      "Melanie was born in Mechanicville, Maryland, and grew up in a large and lively family with nine siblings. She is grateful for her family, including her mother, BillieJo Prettyman, and treasures the memory of her late father, Ronald Prettyman, who passed away in 2022. Melanie’s academic journey led her to earn a Bachelor’s degree in Biochemistry and a Master’s degree in Software Development, both from the University of Utah. She now works as a Software Engineer for a dynamite company. In her free time, Melanie loves hosting themed parties, crocheting intricate designs, and escaping into the magical realms of fantasy novels. Her vibrant personality and knack for bringing people together make her a cherished friend, sister, and partner.",
  },
};
...
export const AccommodationsConstants = {
  ...
  content: {
    intro:
      "We are delighted to invite you to celebrate our wedding at the beautiful Château Du Val! For those traveling, we have several accommodation options to consider.",
    chateauStay:
      "Our venue includes overnight accommodations from Thursday, September 11th at 2:00 PM to Sunday, September 14th at 2:00 PM. Rooms at the château are completely free for guests who wish to stay. The château will primarily house our family and wedding party, but we do have a limited number of additional beds available for other guests. These will be offered on a first-come, first-served basis once RSVPs are finalized.",
    notes: [
      "The château is an adults-only venue—no children are permitted.",
      "If you would like to stay at the château, we will provide a reservation spreadsheet where you can select an available bed and add your name. This will be available at the end of May once all RSVPs are confirmed.",
    ],
    alternativeIntro:
      "If you prefer to book your own stay or if château availability is full, there are several lovely hotels and rentals nearby:",
    finalNote:
      "If you are interested in a free stay at the château, we recommend waiting until the end of May before booking alternative accommodations. At that time, we will have a clearer idea of availability for additional guests. We can't wait to celebrate with you! 💛",
  },
  alternativeAccommodations: [
    {
      name: "Château de Bézyl",
    ...
    },
    {
      ...
      description:
        "Offers comfortable rooms, free private parking, a garden, and a daily continental breakfast. Conveniently located near golf courses, Brocéliande Forest, and Merlin’s Tomb.",
    },
    {
      name: "Sedrez Hotel",
      ...
      description:
        "A recently renovated hotel near the Redon train station, marina, and shopping district—ideal for those wanting easy access to local attractions.",
    },
    {
      name: "Logis Hotel",
