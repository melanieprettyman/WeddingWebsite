...
export const CoupleConstants = {
    mitch:{
        name:"Mitch Wopat",
        about:"Mitch grew up in Germantown, Wisconsin, where his natural curiosity and love for discovery fueled his passion for science. His academic journey began with a degree in Biochemistry from Stevens Point, continued with a Master’s in Pharmacology at St. John’s University in New York City, and culminated in a PhD in Biochemistry at the University of Utah. When he’s not immersed in science, Mitch enjoys exploring imaginative worlds through sci-fi novels, expressing his creativity with painting, and unwinding with video games. As the only child of Tanya Weber and James Wopat, he shares a close bond with his family. Known for his sharp analytical mind and natural ability to lead, Mitch is a trusted friend, devoted son, and someone who inspires those around him."
    },
    melanie:{
        name:"Melanie Prettyman",
        about:"Melanie was born in Mechanicville, Maryland, and grew up in a large and lively family with nine siblings. She is grateful for her family, including her mother, BillieJo Prettyman, and treasures the memory of her late father, Ronald Prettyman, who passed away in 2022. Melanie’s academic journey led her to earn a Bachelor’s degree in Biochemistry and a Master’s degree in Software Development, both from the University of Utah. She now works as a Software Engineer for a dynamite company. In her free time, Melanie loves hosting themed parties, crocheting intricate designs, and escaping into the magical realms of fantasy novels. Her vibrant personality and knack for bringing people together make her a cherished friend, sister, and partner."
    }
};
